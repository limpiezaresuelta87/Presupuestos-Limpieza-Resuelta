 ...
 *
 * A partir de ahora esto lo maneja solo el despliegue automático (ver
 * .github/workflows/deploy.yml): cada vez que se sube un cambio a GitHub,
 * reemplaza CACHE_PLACEHOLDER de acá abajo por el identificador único de
 * ese commit, así el navegador siempre se entera de que hay una versión
 * nueva -- ya no hace falta acordarse de subir un número a mano.
 */

const CACHE_VERSION = 'CACHE_PLACEHOLDER';
